...
dataset_dir = rf'D:\classification\data\X1'
train_dir = rf'D:\classification\data\X1_split/train/'
valid_dir = rf'D:\classification\data\X1_split/val/'
test_dir = rf'D:\classification\data\X1_split/test/'
